...
> **"NoOps is the union of people, processes and automation to enable organizations to deploy, monitor, and improve cloud operations**." - *John Spinella, Creator of the Azure NoOps Accelerator*
