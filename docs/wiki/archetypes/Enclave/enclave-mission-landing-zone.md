# Enclave: Hub/Spoke (Mission Landing Zone)
...
* [Platform Deployment](#platform-deployment)
  ...
  * Deployment Scenarios
    ...
    * [Hub/Spoke](#deployment-scenarios-for-mission-landing-zone)
  * Example Deployment Parameters
    * [Azure Firewall Policy](#example-deployment-parameters-for-azure-firewall-policy)
    * [Hub/Spoke](#example-deployment-parameters-for-mission-landing-zone)
* [Workload Deployment](#workload-deployment)
  ...
  * Deployment Scenarios
    * [Azure Firewall Policy](#deployment-scenarios-for-azure-firewall-policy)
    * [Web App](#deployment-scenarios-for-mission-landing-zone)
  * Example Deployment Parameters
    * [Azure Firewall Policy](#example-deployment-parameters-for-azure-firewall-policy)
    * [Web App](#example-deployment-parameters-for-mission-landing-zone)

## Overview

The recommended enclave design achieves the purpose of hosting [**IL2-IL6** workloads](cloud only).

![Mission Landing Zone](../media/architecture/hubnetwork-azfw/hubnetwork-azfw-design.jpg)
...
## Management Spokes (Tiers) Virtual Network

* Operations (Tier 0) - to host any privileged access workstations (PAW), with Management Public IPs forwarded via the hub's firewall.
* Identity (Tier 1) - to host any privileged access workstations (PAW), with Management Public IPs forwarded via the hub's firewall.
* Shared Services (Tier 2) - to host any privileged access workstations (PAW), with Management Public IPs forwarded via the hub's firewall.
