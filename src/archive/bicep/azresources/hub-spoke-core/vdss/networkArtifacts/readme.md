...
This module defines network artifacts deployment based on the recommendations from the Azure Mission Landing Zone Conceptual Architecture.  
...
## Network Artifacts Parameters

The module requires the following inputs for Network Artifacts:
