...
- [Azure Active Directory Domain Services `[Microsoft.AAD/DomainServices]`](#azure-active-directory-domain-services-microsoftaaddomainservices)
  ...
  - [Considerations](#considerations)
    - [Create self-signed certificate for secure LDAP](#create-self-signed-certificate-for-secure-ldap)
  - [Outputs](#outputs)
