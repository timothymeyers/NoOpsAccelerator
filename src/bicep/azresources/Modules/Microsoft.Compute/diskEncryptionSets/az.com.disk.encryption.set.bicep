...
module keyVaultAccessPolicies '../../Microsoft.KeyVault/vaults/az.sec.key.vault.bicep' = {
...
module diskEncryptionSet_roleAssignments './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
