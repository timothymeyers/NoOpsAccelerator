...
@description('Optional. Specifies the storage account state for the managed disk. - Generalized, Specialized ')
...
module image_roleAssignments './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
