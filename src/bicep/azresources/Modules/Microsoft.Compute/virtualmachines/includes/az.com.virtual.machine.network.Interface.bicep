...
module networkInterface_publicIPAddresses '../../../Microsoft.Network/publicIPAddress/az.net.public.ip.address.bicep' = [for (ipConfiguration, index) in ipConfigurations: if (contains(ipConfiguration, 'pipconfiguration')) {
...
module networkInterface '../../../Microsoft.Network/networkInterfaces/az.net.network.interface.bicep' = {
