...
module tags_sub './subscriptions/az.resources.tags.sub.bicep' = if (!empty(subscriptionId) && empty(resourceGroupName)) {
...
module tags_rg './resourceGroups/az.resources.tags.rg.bicep' = if (!empty(resourceGroupName) && !empty(subscriptionId)) {
