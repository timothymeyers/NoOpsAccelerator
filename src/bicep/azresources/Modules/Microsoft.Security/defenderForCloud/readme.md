# Microsoft Defender for Cloud `[Microsoft.Security/azureSecurityCenter]`

This template enables Microsoft Defender for Cloud - Standard tier by default, could be overridden.
