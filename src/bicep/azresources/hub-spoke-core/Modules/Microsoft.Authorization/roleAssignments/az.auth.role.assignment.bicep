...
module roleAssignment_mg 'managementGroup/az.auth.role.assignment.mg.bicep' = if (empty(subscriptionId) && empty(resourceGroupName)) {
...
module roleAssignment_sub 'subscription/az.auth.role.assignment.sub.bicep' = if (!empty(subscriptionId) && empty(resourceGroupName)) {
...
module roleAssignment_rg 'resourceGroup/az.auth.role.assignment.rg.bicep' = if (!empty(resourceGroupName) && !empty(subscriptionId)) {
