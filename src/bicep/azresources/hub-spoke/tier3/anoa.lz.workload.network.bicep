...
module modWorkloadVirtualNetworkPeerings '../../hub-spoke/peering/spoke/anoa.lz.spoke.network.peering.bicep' = {
...
module modHubToWorkloadVirtualNetworkPeering '../../hub-spoke/peering/hub/anoa.lz.hub.network.peerings.bicep' = {
