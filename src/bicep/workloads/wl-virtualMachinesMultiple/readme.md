# NoOps Accelerator - Workloads - Multiple Virtual Machines
...
This workload module deploys one or multiple Virtual Machines.
...
The docs on Azure Key Vault: <https://docs.microsoft.com/en-us/azure/key-vault/>. This workload shows how to deploy one or multiple Virtual Machines using Bicep to support the deployment. By default, this template will deploy resources into standard default Hub/Spoke subscriptions and resource groups.
