...
module "dev_env_acr_aks_cluster" {
  ...
  // Global Settings
  location            = var.location
  resource_group_name = module.dev_env_aks_workload_spoke_network.resource_group_name
  vnet_subnet_id      = module.dev_env_aks_workload_network.subnet_ids["aks"]
  ...
  virtual_networks_to_link = {
    ...
    (module.dev_env_aks_workload_spoke_network.virtual_network_name) = {
      subscription_id     = var.wl_subid
      resource_group_name = module.dev_env_aks_workload_spoke_network.resource_group_name
    }
  }
