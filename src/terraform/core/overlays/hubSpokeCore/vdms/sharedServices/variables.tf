...
variable "svcs_virtual_network_name" {
  ...
  type        = string
  default     = "shared-services-vnet"
}

variable "svcs_subnet_name" {
  description = "Subnet Name for the svcs deployment"
  type        = string
  default     = "shared-services-snet"
}
...
variable "svcs_network_security_group_name" {
  description = " The name of the Network Security Group to apply to the svcs Virtual Network."
  type        = string
  default     = ""
}
...
variable "enable_resource_locks" {
  description = "Flag to enable locks on the shared services resources"
  type        = bool
  default     = true
}
