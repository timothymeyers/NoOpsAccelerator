...
variable "id_log_storage_account_name" {
...
variable "id_virtual_network_name" {
  description = "Virtual Network Name for the deployment"
  type        = string
  default     = "operations-vnet"
}

variable "id_subnet_name" {
  description = "Subnet Name for the id deployment"
  type        = string
...
variable "id_network_security_group_name" {
  description = " The name of the Network Security Group to apply to the id Virtual Network."
  type        = string
  default     = ""
}
...
variable "enable_resource_locks" {
  description = "Flag to enable locks on the identity resources"
  type        = bool
  default     = true
}
