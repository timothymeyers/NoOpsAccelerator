locals {
  ...
  regions = {
    ...
    usgov-virginia   = "usgovvirginia" # US Government zones
    usgov-texas      = "usgovtexas"    # US Government zones
  ...
  cli_names = {
    ...
    "usgov-virginia" = "usgovvirginia" # "US Gov Virginia"
  }
  ...
  paired_region = try(local.paired[var.location_slug], null)
}
