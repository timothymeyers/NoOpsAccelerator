...
output "id_subid" {
  description = "Subscription ID where the Tier 0 Resource Group is provisioned"
  value       = coalesce(var.id_subid, var.hub_subid)
}

output "id_rgname" {
  description = "The Tier 0 Resource Group name"
  value       = module.mod_id_resource_group.name
}

output "id_vnetname" {
  description = "The Tier 0 Virtual Network name"
  value       = module.mod_networking_identity.virtual_network_name
}

output "id_snetids" {
  description = "The Tier 0 Virtual Network Subnet ids"
  value       = module.mod_networking_identity.subnet_ids
}
